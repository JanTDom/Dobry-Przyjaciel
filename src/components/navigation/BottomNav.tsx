...
import { Sun, BookOpen, ShieldAlert, HeartHandshake, Compass } from "lucide-react";
...
export const BottomNav: React.FC = () => {
  ...
  const links = [
    ...
    { href: "/idea", label: "Idea", icon: <Compass size={20} /> },
    { href: "/sos", label: "Spokój", icon: <ShieldAlert size={20} /> },
  ];

  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-2xl border-t border-cream-300 px-3 py-2 pb-safe shadow-lg">
